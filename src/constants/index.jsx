export const features = [
  {
    ...
    title: "Perfeito para quem busca praticidade!",
    text: "Com atualizações constantes, o NutriZen está sempre evoluindo para melhorar a experiência do usuário, inovando a forma de se fazer dieta.",
    button: {
      icon: "/images/magictouch.svg",
      title: "Assista uma demostração",
    },
  },
  {
    id: "1",
    icon: "/images/feature-2.png",
    caption: "NutriZen é um programa de código aberto",
    title: "Venha fazer parte da comunidade.",
    text: "NutriZen foi desenvolvido com a colaboração de inúmeras pessoas para oferecer a melhor experiência possível aos usuários, venha fazer parte e faça sua contribuição.",
    button: {
      icon: "/images/github.svg",
      title: "Veja a documentação",
    },
  },
];
...
export const details = [
  ...
  },
  {
    ...
    title: "Sua dieta como mágica.",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "Seu progresso guardado",
  },
];
...
export const faq = [
  {
    id: "0",
    question: "O que é NutriZen?",
    answer:
      "O NutriZen é um app feito para apoiar sua dieta, com desafios diários, descontos e muito mais!",
  },
  {
    id: "1",
    question: "Eu consigo acessar em outras plataformas?",
    answer:
      "Sim, NutriZen está em todas as plataformas.",
  },
  {
    id: "2",
    question: "Com que frequência tem atualizações?",
    answer:
      "Frequentemente, como é um aplicativo open source, sempre tem contribuições novas. ",
  },
  {
    id: "3",
    question: "O que é open source?",
    answer:
      "Open source (código aberto) é um modelo de desenvolvimento de software em que o código-fonte é disponibilizado publicamente, permitindo que qualquer pessoa use, modifique e distribua. Isso promove colaboração, transparência e inovação.",
  },
  {
    id: "4",
    question: "Eu terei que pagar algo? ",
    answer:
      "Não, Nutrizen é um aplicativo gratuito e nunca deixará de ser.",
  },
  {
    id: "5",
    question: "Tem como meu nutricinista criar minha dieta no app?",
    answer:
      "Sim, o aplicativo é dividido em dois perfis de usuários: os nutricionistas, que podem criar e personalizar dietas, e os clientes, que acessam seus planos alimentares.",
  },
  {
    id: "6",
    question: "E se eu não tiver nutricionista? ",
    answer:
      "Não se preocupe! O app conta com integração de IA para criar sua dieta. Porém, é importante lembrar que essa é apenas uma orientação, e o ideal é consultar um profissional qualificado.",
  },
  {
    id: "7",
    question: "O app só tem dieta?",
    answer:
      "Não, o NutriZen vai além! Ele oferece diversas funcionalidades, como uma rede social, acompanhamento do consumo diário de água e muito mais. ",
  },
  {
    id: "8",
    question: "E para exercícios físicos, tem algo?",
    answer:
      "Infelizmente não, mas em breve lançaremos um app totalmente voltado a prática de exercícios.",
  },
  {
    id: "9",
    question: "Existe alguma comunidade para participar?",
    answer:
      "Sim existe, temos comunidades no Discord e no Reddit.",
  },
];
